            # F-T2-002-02 — Working Patterns

            > **Conceptual Stack Layer:** Platform-Feature
            > **Space:** Platform
            > **Owner:** Domain Engineering Team
            > **Companion files:** `F-T2-002-02.uvl`, `F-T2-002-02.aui.yaml`
            ...
            > - **Status:** DRAFT
            > - **Feature ID:** `F-T2-002-02`
            > - **Suite:** `t2`
            > - **Node type:** LEAF
            > - **Parent:** `F-T2-002` — see `F-T2-002.md`
            > - **Companion UVL:** `F-T2-002-02.uvl`
            > - **Companion AUI:** `F-T2-002-02.aui.yaml`
...
├── F-T2-002-02  Working Patterns  [LEAF] <-- you are here
...
```
            ...
            | `F-T2-002-02.uvl` | Companion UVL — attribute schema, cross-suite requires |
            | `F-T2-002-02.aui.yaml` | Companion AUI — screen contract |
...
> They expect: The old pattern is superseded and capacity buckets are rebuilt.
            ...
            **Screen: Working Patterns — Default State**
            ...
            Fields are defined authoritatively in `domain-specs/t2_cap-spec.md` §3 (Domain Model) and §6 (REST API). This feature renders the fields relevant to working patterns.
            ...
            See companion file: `contracts/aui/F-T2-002-02.aui.yaml`
...
| CAP_ADMIN | Y | Y | Y | Y |
            ...
            **AC-2: Change to 3-Shift**
            ...
            |---|---|---|
            | `F-T2-002-02` | T1 Reference Data | Validation of codes |
