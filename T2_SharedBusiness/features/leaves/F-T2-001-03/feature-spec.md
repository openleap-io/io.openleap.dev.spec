            # F-T2-001-03 — Address Management

            > **Conceptual Stack Layer:** Platform-Feature
            > **Space:** Platform
            > **Owner:** Domain Engineering Team
            > **Companion files:** `F-T2-001-03.uvl`, `F-T2-001-03.aui.yaml`
            ...
            > - **Status:** DRAFT
            > - **Feature ID:** `F-T2-001-03`
            > - **Suite:** `t2`
            > - **Node type:** LEAF
            > - **Parent:** `F-T2-001` — see `F-T2-001.md`
            > - **Companion UVL:** `F-T2-001-03.uvl`
            > - **Companion AUI:** `F-T2-001-03.aui.yaml`
...
├── F-T2-001-03  Address Management  [LEAF] <-- you are here
...
```
            ...
            | `F-T2-001-03.uvl` | Companion UVL — attribute schema, cross-suite requires |
            | `F-T2-001-03.aui.yaml` | Companion AUI — screen contract |
...
> They expect: The address is updated and linked documents are flagged for review.
            ...
            **Screen: Address Management — Default State**
            ...
            Fields are defined authoritatively in `domain-specs/t2_bp-spec.md` §3 (Domain Model) and §6 (REST API). This feature renders the fields relevant to address management.
            ...
            See companion file: `contracts/aui/F-T2-001-03.aui.yaml`
...
| BP_ADMIN | Y | Y | Y | Y |
            ...
            **AC-2: Update Registered Address**
            ...
            |---|---|---|
            | `F-T2-001-03` | T1 Reference Data | Validation of codes |
