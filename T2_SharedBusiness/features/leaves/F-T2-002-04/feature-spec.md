            # F-T2-002-04 — Availability Query

            > **Conceptual Stack Layer:** Platform-Feature
            > **Space:** Platform
            > **Owner:** Domain Engineering Team
            > **Companion files:** `F-T2-002-04.uvl`, `F-T2-002-04.aui.yaml`
            ...
            > - **Status:** DRAFT
            > - **Feature ID:** `F-T2-002-04`
            > - **Suite:** `t2`
            > - **Node type:** LEAF
            > - **Parent:** `F-T2-002` — see `F-T2-002.md`
            > - **Companion UVL:** `F-T2-002-04.uvl`
            > - **Companion AUI:** `F-T2-002-04.aui.yaml`
...
├── F-T2-002-03  Holiday Management  [LEAF]
├── F-T2-002-04  Availability Query  [LEAF] <-- you are here
```
            ...
            | `F-T2-002-04.uvl` | Companion UVL — attribute schema, cross-suite requires |
            | `F-T2-002-04.aui.yaml` | Companion AUI — screen contract |
...
> They expect: The system returns bookable slots for the requested date range.
            ...
            **Screen: Availability Query — Default State**
            ...
            Fields are defined authoritatively in `domain-specs/t2_cap-spec.md` §3 (Domain Model) and §6 (REST API). This feature renders the fields relevant to availability query.
            ...
            See companion file: `contracts/aui/F-T2-002-04.aui.yaml`
...
| BOOKING_USER | Y | Y | Y | N |
            ...
            **AC-2: Check Delivery Slots**
            ...
            |---|---|---|
            | `F-T2-002-04` | T1 Reference Data | Validation of codes |
