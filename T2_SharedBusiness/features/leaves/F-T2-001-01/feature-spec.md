            # F-T2-001-01 — Create/Update Party

            > **Conceptual Stack Layer:** Platform-Feature
            > **Space:** Platform
            > **Owner:** Domain Engineering Team
            > **Companion files:** `F-T2-001-01.uvl`, `F-T2-001-01.aui.yaml`
            ...
            > - **Status:** DRAFT
            > - **Feature ID:** `F-T2-001-01`
            > - **Suite:** `t2`
            > - **Node type:** LEAF
            > - **Parent:** `F-T2-001` — see `F-T2-001.md`
            > - **Companion UVL:** `F-T2-001-01.uvl`
            > - **Companion AUI:** `F-T2-001-01.aui.yaml`
            ...
            **Exit points:**
            ...
            ├── F-T2-001-01  Create/Update Party  [LEAF] <-- you are here
...
```
            ...
            | `F-T2-001-01.uvl` | Companion UVL — attribute schema, cross-suite requires |
            | `F-T2-001-01.aui.yaml` | Companion AUI — screen contract |
...
> They expect: The party status changes and a party.statusChanged event fires.
            ...
            **Screen: Create/Update Party — Default State**
            ...
            Fields are defined authoritatively in `domain-specs/t2_bp-spec.md` §3 (Domain Model) and §6 (REST API). This feature renders the fields relevant to create/update party.
            ...
            See companion file: `contracts/aui/F-T2-001-01.aui.yaml`
...
| BP_ADMIN | Y | Y | Y | Y |
            ...
            **AC-3: Activate Party**
            ...
            |---|---|---|
            | `F-T2-001-01` | T1 Reference Data | Validation of codes |
