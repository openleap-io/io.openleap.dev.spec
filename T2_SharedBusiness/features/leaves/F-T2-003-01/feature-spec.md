            # F-T2-003-01 — Slot & Booking

            > **Conceptual Stack Layer:** Platform-Feature
            > **Space:** Platform
            > **Owner:** Domain Engineering Team
            > **Companion files:** `F-T2-003-01.uvl`, `F-T2-003-01.aui.yaml`
            ...
            > - **Status:** DRAFT
            > - **Feature ID:** `F-T2-003-01`
            > - **Suite:** `t2`
            > - **Node type:** LEAF
            > - **Parent:** `F-T2-003` — see `F-T2-003.md`
            > - **Companion UVL:** `F-T2-003-01.uvl`
            > - **Companion AUI:** `F-T2-003-01.aui.yaml`
            ...
            **Exit points:**
            ...
            ├── F-T2-003-01  Slot & Booking  [LEAF] <-- you are here
├── F-T2-003-02  Booking Templates  [LEAF]
```
            ...
            | `F-T2-003-01.uvl` | Companion UVL — attribute schema, cross-suite requires |
            | `F-T2-003-01.aui.yaml` | Companion AUI — screen contract |
...
> They expect: The booking is cancelled, the slot is freed, and a booking.cancelled event fires.
            ...
            **Screen: Slot & Booking — Default State**
            ...
            Fields are defined authoritatively in `domain-specs/t2_cap-spec.md` §3 (Domain Model) and §6 (REST API). This feature renders the fields relevant to slot & booking.
            ...
            See companion file: `contracts/aui/F-T2-003-01.aui.yaml`
...
| BOOKING_USER | Y | Y | Y | N |
            ...
            **AC-3: Cancel Booking**
            ...
            |---|---|---|
            | `F-T2-003-01` | T1 Reference Data | Validation of codes |
