            # F-T2-003-02 — Booking Templates

            > **Conceptual Stack Layer:** Platform-Feature
            > **Space:** Platform
            > **Owner:** Domain Engineering Team
            > **Companion files:** `F-T2-003-02.uvl`, `F-T2-003-02.aui.yaml`
            ...
            > - **Status:** DRAFT
            > - **Feature ID:** `F-T2-003-02`
            > - **Suite:** `t2`
            > - **Node type:** LEAF
            > - **Parent:** `F-T2-003` — see `F-T2-003.md`
            > - **Companion UVL:** `F-T2-003-02.uvl`
            > - **Companion AUI:** `F-T2-003-02.aui.yaml`
            ...
            This feature lets authorized users create and manage booking templates (default duration, buffers, advance rules, cancellation policy) so that slot generation is consistent .
            ...
            **Exit points:**
            ...
            ```
            F-T2-003  Booking Management  [COMPOSITION]
            ├── F-T2-003-01  Slot & Booking  [LEAF]
├── F-T2-003-02  Booking Templates  [LEAF] <-- you are here
```
            ...
            |---|---|
            | `F-T2-003.md` | Parent composition — variability structure |
            | `F-T2-003-02.uvl` | Companion UVL — attribute schema, cross-suite requires |
            | `F-T2-003-02.aui.yaml` | Companion AUI — screen contract |
            ...
            Create and manage booking templates (default duration, buffers, advance rules, cancellation policy) so that slot generation is consistent.

            ### 1.2 User Scenarios


**Scenario 1: Create Template**
> A Warehouse Manager wants to create a standard 2-hour delivery template with 15min buffers because all deliveries should follow the same slot rules.
> They navigate to the Booking Templates screen, fill in the required data, and submit.
> They expect: The template is stored and can be applied when generating slots.


**Scenario 2: Update Cancellation Policy**
> A Operations Manager wants to change the cancellation notice from 24h to 48h because too many late cancellations are causing waste.
> They navigate to the Booking Templates screen, fill in the required data, and submit.
> They expect: The template is updated and new bookings inherit the new policy.
            ...
            sequenceDiagram
                ...
                participant UI as Booking Templates UI
                participant BFF as BFF
                participant SVC as t2-cap-svc

                User->>UI: Navigate to Booking Templates
            ...
            **Screen: Booking Templates — Default State**

            ```
            ┌─────────────────────────────────────────────────┐
            │  [Booking Management] > Booking Templates              │  ← Breadcrumb
            ├─────────────────────────────────────────────────┤
            │  ┌─ Core Data ─────────────────────────────────┐│
            ...
            Fields are defined authoritatively in `domain-specs/t2_cap-spec.md` §3 (Domain Model) and §6 (REST API). This feature renders the fields relevant to booking templates.
            ...
            See companion file: `contracts/aui/F-T2-003-02.aui.yaml`
            ...
            **AC-1: Create Template**
            - **Given** a Warehouse Manager is on the Booking Templates screen
            - **When** they create a standard 2-hour delivery template with 15min buffers
            - **Then** The template is stored and can be applied when generating slots.

            **AC-2: Update Cancellation Policy**
            - **Given** a Operations Manager is on the Booking Templates screen
            - **When** they change the cancellation notice from 24h to 48h
            - **Then** The template is updated and new bookings inherit the new policy.
            ...
            |---|---|---|
            | `F-T2-003-02` | T1 Reference Data | Validation of codes |
            ...
            |---|---|---|---|
            | `ext.f_t2_003_02.customFields` | zone | Additional fields from T3 domains | Zone hidden |
