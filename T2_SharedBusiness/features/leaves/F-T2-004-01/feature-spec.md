            # F-T2-004-01 — Period CRUD & Hierarchy

            > **Conceptual Stack Layer:** Platform-Feature
            > **Space:** Platform
            > **Owner:** Domain Engineering Team
            > **Companion files:** `F-T2-004-01.uvl`, `F-T2-004-01.aui.yaml`
            ...
            > - **Status:** DRAFT
            > - **Feature ID:** `F-T2-004-01`
            > - **Suite:** `t2`
            > - **Node type:** LEAF
            > - **Parent:** `F-T2-004` — see `F-T2-004.md`
            > - **Companion UVL:** `F-T2-004-01.uvl`
            > - **Companion AUI:** `F-T2-004-01.aui.yaml`
            ...
            **Exit points:**
            ...
            ```
            F-T2-004  Period Management  [COMPOSITION]
            ├── F-T2-004-01  Period CRUD & Hierarchy  [LEAF] <-- you are here
```
            ...
            |---|---|
            | `F-T2-004.md` | Parent composition — variability structure |
            | `F-T2-004-01.uvl` | Companion UVL — attribute schema, cross-suite requires |
            | `F-T2-004-01.aui.yaml` | Companion AUI — screen contract |
...
> They expect: The period status changes to CLOSED and downstream domains are notified.
            ...
            **Screen: Period CRUD & Hierarchy — Default State**
            ...
            Fields are defined authoritatively in `domain-specs/t2_cap-spec.md` §3 (Domain Model) and §6 (REST API). This feature renders the fields relevant to period crud & hierarchy.
            ...
            See companion file: `contracts/aui/F-T2-004-01.aui.yaml`
...
| CAP_ADMIN | Y | Y | Y | Y |
            ...
            **AC-2: Close Period**
            ...
            |---|---|---|
            | `F-T2-004-01` | T1 Reference Data | Validation of codes |
