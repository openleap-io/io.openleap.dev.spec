            # F-T2-002-01 — Resource Calendars

            > **Conceptual Stack Layer:** Platform-Feature
            > **Space:** Platform
            > **Owner:** Domain Engineering Team
            > **Companion files:** `F-T2-002-01.uvl`, `F-T2-002-01.aui.yaml`
            ...
            > - **Status:** DRAFT
            > - **Feature ID:** `F-T2-002-01`
            > - **Suite:** `t2`
            > - **Node type:** LEAF
            > - **Parent:** `F-T2-002` — see `F-T2-002.md`
            > - **Companion UVL:** `F-T2-002-01.uvl`
            > - **Companion AUI:** `F-T2-002-01.aui.yaml`
            ...
            **Exit points:**
            ...
            ├── F-T2-002-01  Resource Calendars  [LEAF] <-- you are here
...
```
            ...
            | `F-T2-002-01.uvl` | Companion UVL — attribute schema, cross-suite requires |
            | `F-T2-002-01.aui.yaml` | Companion AUI — screen contract |
...
> They expect: An ORGANIZATION calendar is created and linked to the plant party.
            ...
            **Screen: Resource Calendars — Default State**
            ...
            Fields are defined authoritatively in `domain-specs/t2_cap-spec.md` §3 (Domain Model) and §6 (REST API). This feature renders the fields relevant to resource calendars.
            ...
            See companion file: `contracts/aui/F-T2-002-01.aui.yaml`
...
| CAP_ADMIN | Y | Y | Y | Y |
            ...
            **AC-2: Create Org Calendar**
            ...
            |---|---|---|
            | `F-T2-002-01` | T1 Reference Data | Validation of codes |
