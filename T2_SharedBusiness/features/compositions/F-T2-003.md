...
| `F-T2-003-02` | Booking Templates | LEAF | optional |
        ...
        ```
        T2_UI  (suite root)
        +-- F-T2-003  Booking Management  <-- you are here
            +-- F-T2-003-01  Slot & Booking  [LEAF] [mandatory]
    +-- F-T2-003-02  Booking Templates  [LEAF] [optional]
```
        ...
        **Business rationale for this structure:**
        ...
        | This Node | Requires | Rationale |\n|---|---|---|\n| `F-T2-003` | `F-T2-002` | Bookings require calendars for slot computation |

        ### 2.3 Edge Cases

        - If the optional child `F-T2-003-02` is excluded, related data entry fields are hidden in the mandatory children's screens.
