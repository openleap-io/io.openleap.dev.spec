...
- `T3_Domains/FI/` - Finance domain specifications (primary event source)
- `T3_Domains/FAC/` - Factoring domain specifications
- `T3_Domains/OPS/` - Operations domain specifications
- `T1_Platform/rpt/` - Reporting platform service
- `T1_Platform/dms/` - Document management platform service
...
**Technical Standards:**
- [system-topology.md](https://github.com/openleap-io/io.openleap.dev.hub/blob/main/architecture/system-topology.md) - Platform architecture overview (BI is Tier-4 consumer)
