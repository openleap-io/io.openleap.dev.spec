...
> **Companion UVL:** `F-TKS-240.uvl`
> **Companion AUI:** `contracts/aui/F-TKS-240.aui.yaml`

---

## SS0 — Identity & Purpose

**Purpose:** Placeholder leaf reserving the variability slot for a future chat provider (Slack, Teams, Intercom). No adapter shipped in v1.
...
Canonical view-model composed by BFF; see `contracts/aui/F-TKS-240.aui.yaml` for the AUI (abstract UI) contract and `../domain-specs/*.md` §6 for the underlying REST calls.
