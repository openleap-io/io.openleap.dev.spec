# F-TKS-220 — Web Form / Customer Portal
...
> **Companion UVL:** `F-TKS-220.uvl`
> **Companion AUI:** `contracts/aui/F-TKS-220.aui.yaml`

---

## SS0 — Identity & Purpose

**Purpose:** Public-facing form that lets unauthenticated or portal-authenticated reporters submit tickets. Captcha-protected; renders KB suggestions live.
...
Canonical view-model composed by BFF; see `contracts/aui/F-TKS-220.aui.yaml` for the AUI (abstract UI) contract and `../domain-specs/*.md` §6 for the underlying REST calls.
