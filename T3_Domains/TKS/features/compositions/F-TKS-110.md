...
**Purpose:** Comments & Notes — grouping feature within the TKS suite.

**Position in tree:** `TKS_UI` → `F-TKS-110`
...
**Business rationale:** Comments & Notes is a mandatory capability within the TKS suite. Features can be selected or combined per product composition.
