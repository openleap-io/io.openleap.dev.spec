...
**Purpose:** AI Auto-Triage — grouping feature within the TKS suite.

**Position in tree:** `TKS_UI` → `F-TKS-510`
...
**Business rationale:** AI Auto-Triage is a optional capability within the TKS suite. Features can be selected or combined per product composition.
