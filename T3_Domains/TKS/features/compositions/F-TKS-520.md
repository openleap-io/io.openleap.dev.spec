...
> **Companion UVL:** `F-TKS-520.uvl`
> **Cross-suite deps:** tech.ai

---

## SS0 — Identity

**Purpose:** AI Writing Assistant — grouping feature within the TKS suite.

**Position in tree:** `TKS_UI` → `F-TKS-520`
...
**Business rationale:** AI Writing Assistant is a optional capability within the TKS suite. Features can be selected or combined per product composition.
