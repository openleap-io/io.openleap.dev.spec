...
> **Companion UVL:** `F-TKS-300.uvl`
> **Cross-suite deps:** shared.bp

---

## SS0 — Identity

**Purpose:** Knowledge Articles — grouping feature within the TKS suite.

**Position in tree:** `TKS_UI` → `F-TKS-300`
...
**Business rationale:** Knowledge Articles is a optional capability within the TKS suite. Features can be selected or combined per product composition.
