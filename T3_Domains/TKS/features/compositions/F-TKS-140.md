...
> **Companion UVL:** `F-TKS-140.uvl`
> **Cross-suite deps:** tech.dms

---

## SS0 — Identity

**Purpose:** Ticket Attachments — grouping feature within the TKS suite.

**Position in tree:** `TKS_UI` → `F-TKS-140`
...
**Business rationale:** Ticket Attachments is a optional capability within the TKS suite. Features can be selected or combined per product composition.
