...
**Purpose:** Configuration Items — grouping feature within the TKS suite.

**Position in tree:** `TKS_UI` → `F-TKS-400`
...
**Business rationale:** Configuration Items is a optional capability within the TKS suite. Features can be selected or combined per product composition.
