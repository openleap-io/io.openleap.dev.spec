...
**Purpose:** AI Ticket Summary — grouping feature within the TKS suite.

**Position in tree:** `TKS_UI` → `F-TKS-500`
...
**Business rationale:** AI Ticket Summary is a optional capability within the TKS suite. Features can be selected or combined per product composition.
