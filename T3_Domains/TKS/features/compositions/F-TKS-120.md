...
> **Companion UVL:** `F-TKS-120.uvl`
> **Cross-suite deps:** shared.cap, shared.wf

---

## SS0 — Identity

**Purpose:** SLA & Escalation — grouping feature within the TKS suite.

**Position in tree:** `TKS_UI` → `F-TKS-120`
...
**Business rationale:** SLA & Escalation is a optional capability within the TKS suite. Features can be selected or combined per product composition.
