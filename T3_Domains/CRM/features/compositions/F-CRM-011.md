...
> **Parent:** `CRM_UI`
> **Primary service:** `crm.wf`
> **Companion UVL:** `F-CRM-011.uvl`

---

## SS0 — Identity

**Purpose:** Groups all UI features related to workflow automation within the CRM Suite.

### Children

| Feature ID | Name | Node Type | Status |
|-----------|------|-----------|--------|
| `F-CRM-011-01` | Workflow Builder | LEAF | `draft` |
| `F-CRM-011-02` | Workflow Template Library | LEAF | `draft` |
| `F-CRM-011-03` | Workflow Monitor & Logs | LEAF | `draft` |
| `F-CRM-011-04` | Assignment & Escalation Rules | LEAF | `draft` |

**Position in tree:** `CRM_UI` → `F-CRM-011` → 4 leaf features
...
**Business rationale:** Workflow Automation is an extension capability. Tenants may enable a subset of features based on their needs and licensing tier. Each leaf feature provides standalone value.

### Variability Points

| Leaf | Binding Time | Rationale |
|------|-------------|-----------|
| `F-CRM-011-01` | `deploy` | Tenant-configurable |
| `F-CRM-011-02` | `deploy` | Tenant-configurable |
| `F-CRM-011-03` | `deploy` | Tenant-configurable |
| `F-CRM-011-04` | `deploy` | Tenant-configurable |
