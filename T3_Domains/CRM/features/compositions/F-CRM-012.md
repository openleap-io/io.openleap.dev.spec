# F-CRM-012 — Notifications & Alerts
...
> **Parent:** `CRM_UI`
> **Primary service:** `crm.ntf`
> **Companion UVL:** `F-CRM-012.uvl`

---

## SS0 — Identity

**Purpose:** Groups all UI features related to notifications & alerts within the CRM Suite.

### Children

| Feature ID | Name | Node Type | Status |
|-----------|------|-----------|--------|
| `F-CRM-012-01` | Notification Center | LEAF | `draft` |
| `F-CRM-012-02` | Notification Preferences | LEAF | `draft` |
| `F-CRM-012-03` | Channel Configuration | LEAF | `draft` |

**Position in tree:** `CRM_UI` → `F-CRM-012` → 3 leaf features
...
**Business rationale:** Notifications & Alerts is an extension capability. Tenants may enable a subset of features based on their needs and licensing tier. Each leaf feature provides standalone value.

### Variability Points

| Leaf | Binding Time | Rationale |
|------|-------------|-----------|
| `F-CRM-012-01` | `deploy` | Tenant-configurable |
| `F-CRM-012-02` | `deploy` | Tenant-configurable |
| `F-CRM-012-03` | `deploy` | Tenant-configurable |
