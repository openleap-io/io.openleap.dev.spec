...
> **Parent:** `CRM_UI`
> **Primary service:** `crm.doc`
> **Companion UVL:** `F-CRM-009.uvl`

---

## SS0 — Identity

**Purpose:** Groups all UI features related to document management within the CRM Suite.

### Children

| Feature ID | Name | Node Type | Status |
|-----------|------|-----------|--------|
| `F-CRM-009-01` | Document Library | LEAF | `draft` |
| `F-CRM-009-02` | Document Upload & Attach | LEAF | `draft` |
| `F-CRM-009-03` | Document Template Generator | LEAF | `draft` |

**Position in tree:** `CRM_UI` → `F-CRM-009` → 3 leaf features
...
**Business rationale:** Document Management is an extension capability. Tenants may enable a subset of features based on their needs and licensing tier. Each leaf feature provides standalone value.

### Variability Points

| Leaf | Binding Time | Rationale |
|------|-------------|-----------|
| `F-CRM-009-01` | `deploy` | Tenant-configurable |
| `F-CRM-009-02` | `deploy` | Tenant-configurable |
| `F-CRM-009-03` | `deploy` | Tenant-configurable |
