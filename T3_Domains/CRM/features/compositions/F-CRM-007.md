...
> **Parent:** `CRM_UI`
> **Primary service:** `crm.email`
> **Companion UVL:** `F-CRM-007.uvl`

---

## SS0 — Identity

**Purpose:** Groups all UI features related to email communication within the CRM Suite.

### Children

| Feature ID | Name | Node Type | Status |
|-----------|------|-----------|--------|
| `F-CRM-007-01` | Email Compose & Send | LEAF | `draft` |
| `F-CRM-007-02` | Email Inbox & Thread View | LEAF | `draft` |
| `F-CRM-007-03` | Email Template Manager | LEAF | `draft` |
| `F-CRM-007-04` | Email Tracking Dashboard | LEAF | `draft` |

**Position in tree:** `CRM_UI` → `F-CRM-007` → 4 leaf features
...
**Business rationale:** Email Communication is an extension capability. Tenants may enable a subset of features based on their needs and licensing tier. Each leaf feature provides standalone value.

### Variability Points

| Leaf | Binding Time | Rationale |
|------|-------------|-----------|
| `F-CRM-007-01` | `deploy` | Tenant-configurable |
| `F-CRM-007-02` | `deploy` | Tenant-configurable |
| `F-CRM-007-03` | `deploy` | Tenant-configurable |
| `F-CRM-007-04` | `deploy` | Tenant-configurable |
