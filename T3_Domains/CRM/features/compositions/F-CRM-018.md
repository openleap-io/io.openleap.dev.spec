...
> **Parent:** `CRM_UI`
> **Primary service:** `crm.prj`
> **Companion UVL:** `F-CRM-018.uvl`

---

## SS0 — Identity

**Purpose:** Groups all UI features related to customer projects within the CRM Suite.

### Children

| Feature ID | Name | Node Type | Status |
|-----------|------|-----------|--------|
| `F-CRM-018-01` | Project Board & List | LEAF | `draft` |
| `F-CRM-018-02` | Project Detail & Timeline | LEAF | `draft` |
| `F-CRM-018-03` | Onboarding Checklist | LEAF | `draft` |
| `F-CRM-018-04` | Project Task Management | LEAF | `draft` |

**Position in tree:** `CRM_UI` → `F-CRM-018` → 4 leaf features
...
**Business rationale:** Customer Projects is an extension capability. Tenants may enable a subset of features based on their needs and licensing tier. Each leaf feature provides standalone value.

### Variability Points

| Leaf | Binding Time | Rationale |
|------|-------------|-----------|
| `F-CRM-018-01` | `deploy` | Tenant-configurable |
| `F-CRM-018-02` | `deploy` | Tenant-configurable |
| `F-CRM-018-03` | `deploy` | Tenant-configurable |
| `F-CRM-018-04` | `deploy` | Tenant-configurable |
