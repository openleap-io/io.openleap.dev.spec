...
# F-IAM-004-01 — Security Event Logging

> **Conceptual Stack Layer:** Platform-Feature
> **Space:** Platform
> **Owner:** Domain Engineering Team
> **Companion files:** `F-IAM-004-01.uvl`, `F-IAM-004-01.aui.yaml`
...
> - **Status:** DRAFT
> - **Feature ID:** `F-IAM-004-01`
> - **Suite:** `iam`
> - **Node type:** LEAF
> - **Companion UVL:** `uvl/leaves/F-IAM-004-01.uvl`
> - **Companion AUI:** `contracts/aui/F-IAM-004-01.aui.yaml`
...
This feature lets a System (automated) automatically capture all security-relevant events for compliance and forensics.
...
### 1.1 The User Goal
Automatically capture all security-relevant events for compliance and forensics.

### 1.2 User Scenarios
**Scenario 1: Log auth success**
> Store with principal, IP, method

**Scenario 2: Log authz denial**
> Full context logged

**Scenario 3: Log status change**
> Admin ID as actor
...
```
┌──────────────────────────────────────────────────┐
│  ← Back            Security Event Logging     [Cancel]    │
├──────────────────────────────────────────────────┤
...
|---|---|---|:---:|---|
| Event Type * | `iam-audit-svc` | Auto | Y | From routing key |
| Principal ID * | `iam-audit-svc` | Auto | Y | Actor |
| Tenant ID * | `iam-audit-svc` | Auto | Y | Context |
| Action * | `iam-audit-svc` | Auto | Y | What was done |
| Resource | `iam-audit-svc` | Auto |  | Target |
| Outcome * | `iam-audit-svc` | Auto | Y | SUCCESS/FAILURE/DENIED |
| Source IP | `iam-audit-svc` | Auto |  | Client IP |

### 3.2 Actions
| Action | Trigger | Precondition | Confirm | Role | Outcome |
|---|---|---|:---:|---|---|
| Submit | Button | Form valid | — | `System (automated)` | Navigate + toast |
...
See companion file: `contracts/aui/F-IAM-004-01.aui.yaml`
...
| Submit | Always | Form valid | `System (automated)` |

---

## 8. Acceptance Criteria
**AC-001:** Given role `System (automated)`, when all required fields filled and submitted, then record created and toast shown.
