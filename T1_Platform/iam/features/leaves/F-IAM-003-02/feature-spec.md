...
# F-IAM-003-02 — Organization Hierarchy

> **Conceptual Stack Layer:** Platform-Feature
> **Space:** Platform
> **Owner:** Domain Engineering Team
> **Companion files:** `F-IAM-003-02.uvl`, `F-IAM-003-02.aui.yaml`
...
> - **Status:** DRAFT
> - **Feature ID:** `F-IAM-003-02`
> - **Suite:** `iam`
> - **Node type:** LEAF
> - **Companion UVL:** `uvl/leaves/F-IAM-003-02.uvl`
> - **Companion AUI:** `contracts/aui/F-IAM-003-02.aui.yaml`
...
This feature lets a IAM_TENANT_ADMIN manage organizational hierarchy (departments, teams, locations) within a tenant.
...
### 1.1 The User Goal
Manage organizational hierarchy (departments, teams, locations) within a tenant.

### 1.2 User Scenarios
**Scenario 1: Create department**
> Assign principals, scope roles

**Scenario 2: Reorganize**
> Move team, perms update auto
...
```
┌──────────────────────────────────────────────────┐
│  ← Back            Organization Hierarchy     [Cancel]    │
├──────────────────────────────────────────────────┤
...
|---|---|---|:---:|---|
| Org Name * | `iam-tenant-svc` | Text | Y | 3-200 |
| Org Code * | `iam-tenant-svc` | Text | Y | UPPER_SNAKE_CASE |
| Parent Org | `iam-tenant-svc` | Tree select |  | Org hierarchy |
| Type * | `iam-tenant-svc` | Select | Y | DIVISION/DEPARTMENT/TEAM/LOCATION |
| Description | `iam-tenant-svc` | Textarea |  | Max 500 |
...
See companion file: `contracts/aui/F-IAM-003-02.aui.yaml`
