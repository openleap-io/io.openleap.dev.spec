...
# F-IAM-002-04 — Delegation & Impersonation

> **Conceptual Stack Layer:** Platform-Feature
> **Space:** Platform
> **Owner:** Domain Engineering Team
> **Companion files:** `F-IAM-002-04.uvl`, `F-IAM-002-04.aui.yaml`
...
> - **Status:** DRAFT
> - **Feature ID:** `F-IAM-002-04`
> - **Suite:** `iam`
> - **Node type:** LEAF
> - **Companion UVL:** `uvl/leaves/F-IAM-002-04.uvl`
> - **Companion AUI:** `contracts/aui/F-IAM-002-04.aui.yaml`
...
This feature lets a IAM_SYSTEM_ADMIN temporarily impersonate another principal or delegate specific permissions.
...
### 1.1 The User Goal
Temporarily impersonate another principal or delegate specific permissions.

### 1.2 User Scenarios
**Scenario 1: Admin impersonation**
> Both IDs logged

**Scenario 2: Vacation delegation**
...
```
┌──────────────────────────────────────────────────┐
│  ← Back            Delegation & Impersonation     [Cancel]    │
├──────────────────────────────────────────────────┤
...
|---|---|---|:---:|---|
| Type * | `iam-authz-svc` | Select | Y | IMPERSONATION/DELEGATION |
| Target Principal * | `iam-authz-svc` | Typeahead | Y | Active principal |
| Permissions | `iam-authz-svc` | Multi-select |  | Subset of delegator's |
| Valid From * | `iam-authz-svc` | DateTime | Y | >= now |
| Valid To * | `iam-authz-svc` | DateTime | Y | > from, max 30d |
| Reason * | `iam-authz-svc` | Textarea | Y | Min 10 chars |
...
See companion file: `contracts/aui/F-IAM-002-04.aui.yaml`
