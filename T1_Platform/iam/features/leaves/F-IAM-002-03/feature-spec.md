...
# F-IAM-002-03 — ABAC Policy Evaluation

> **Conceptual Stack Layer:** Platform-Feature
> **Space:** Platform
> **Owner:** Domain Engineering Team
> **Companion files:** `F-IAM-002-03.uvl`, `F-IAM-002-03.aui.yaml`
...
> - **Status:** DRAFT
> - **Feature ID:** `F-IAM-002-03`
> - **Suite:** `iam`
> - **Node type:** LEAF
> - **Companion UVL:** `uvl/leaves/F-IAM-002-03.uvl`
> - **Companion AUI:** `contracts/aui/F-IAM-002-03.aui.yaml`
...
This feature lets a IAM_AUTHZ_ADMIN define attribute-based policies that conditionally grant/deny permissions based on context.
...
### 1.1 The User Goal
Define attribute-based policies that conditionally grant/deny permissions based on context.

### 1.2 User Scenarios
**Scenario 1: Time-based restriction**
> Restrict approval to business hours

**Scenario 2: Amount threshold**
> Managers <10K, directors >10K
...
```
┌──────────────────────────────────────────────────┐
│  ← Back            ABAC Policy Evaluation     [Cancel]    │
├──────────────────────────────────────────────────┤
...
|---|---|---|:---:|---|
| Policy Code * | `iam-authz-svc` | Text | Y | UPPER_SNAKE_CASE |
| Policy Name * | `iam-authz-svc` | Text | Y | Max 200 |
| Condition * | `iam-authz-svc` | Code editor | Y | CEL/JSON |
| Effect * | `iam-authz-svc` | Select | Y | ALLOW/DENY |
| Priority * | `iam-authz-svc` | Number | Y | 1-1000 |
| Target Permissions | `iam-authz-svc` | Multi-select |  | Permission catalog |
...
See companion file: `contracts/aui/F-IAM-002-03.aui.yaml`
