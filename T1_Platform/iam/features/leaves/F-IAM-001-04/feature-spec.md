...
# F-IAM-001-04 — Create Device Principal

> **Conceptual Stack Layer:** Platform-Feature
> **Space:** Platform
> **Owner:** Domain Engineering Team
> **Companion files:** `F-IAM-001-04.uvl`, `F-IAM-001-04.aui.yaml`
...
> - **Status:** DRAFT
> - **Feature ID:** `F-IAM-001-04`
> - **Suite:** `iam`
> - **Node type:** LEAF
> - **Companion UVL:** `uvl/leaves/F-IAM-001-04.uvl`
> - **Companion AUI:** `contracts/aui/F-IAM-001-04.aui.yaml`
...
This feature lets a IAM_SYSTEM_ADMIN register an IoT device, kiosk, or terminal that authenticates via device certificate.
...
### 1.1 The User Goal
Register an IoT device, kiosk, or terminal that authenticates via device certificate.

### 1.2 User Scenarios
**Scenario 1: Register warehouse kiosk**
> Upload cert, enable cert-based auth
...
```
┌──────────────────────────────────────────────────┐
│  ← Back            Create Device Principal     [Cancel]    │
├──────────────────────────────────────────────────┤
...
|---|---|---|:---:|---|
| Device Name * | `iam-principal-svc` | Text | Y | 3-100 |
| Device Type * | `iam-principal-svc` | Select | Y | KIOSK/TERMINAL/SENSOR/GATEWAY |
| Serial Number | `iam-principal-svc` | Text |  | Manufacturer |
| Location | `iam-principal-svc` | Text |  | Physical |
| Tenant * | `iam-principal-svc` | Typeahead | Y | Active tenant |
| Certificate * | `iam-principal-svc` | File upload | Y | X.509 PEM |
...
See companion file: `contracts/aui/F-IAM-001-04.aui.yaml`
