...
# F-IAM-001-02 — Create Service Principal

> **Conceptual Stack Layer:** Platform-Feature
> **Space:** Platform
> **Owner:** Domain Engineering Team
> **Companion files:** `F-IAM-001-02.uvl`, `F-IAM-001-02.aui.yaml`
...
> - **Status:** DRAFT
> - **Feature ID:** `F-IAM-001-02`
> - **Suite:** `iam`
> - **Node type:** LEAF
> - **Companion UVL:** `uvl/leaves/F-IAM-001-02.uvl`
> - **Companion AUI:** `contracts/aui/F-IAM-001-02.aui.yaml`
...
This feature lets a IAM_SYSTEM_ADMIN register a service account for a microservice to authenticate via OAuth2 client credentials.
...
### 1.1 The User Goal
Register a service account for a microservice to authenticate via OAuth2 client credentials.

### 1.2 User Scenarios
**Scenario 1: Register microservice**
> Create, KC OAuth2 client, return secret

**Scenario 2: Duplicate client ID rejected**
> 409 conflict
...
```
┌──────────────────────────────────────────────────┐
│  ← Back            Create Service Principal     [Cancel]    │
├──────────────────────────────────────────────────┤
...
|---|---|---|:---:|---|
| Service Name * | `iam-principal-svc` | Text | Y | 3-100, unique |
| Description * | `iam-principal-svc` | Textarea | Y | Max 500 |
| Client ID * | `iam-principal-svc` | Text | Y | Unique |
| Tenant * | `iam-principal-svc` | Typeahead | Y | Active tenant |
| Allowed Scopes | `iam-principal-svc` | Multi-select |  | Scope catalog |
...
See companion file: `contracts/aui/F-IAM-001-02.aui.yaml`
