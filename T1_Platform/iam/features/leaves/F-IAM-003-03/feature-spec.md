...
# F-IAM-003-03 — Tenant Configuration

> **Conceptual Stack Layer:** Platform-Feature
> **Space:** Platform
> **Owner:** Domain Engineering Team
> **Companion files:** `F-IAM-003-03.uvl`, `F-IAM-003-03.aui.yaml`
...
> - **Status:** DRAFT
> - **Feature ID:** `F-IAM-003-03`
> - **Suite:** `iam`
> - **Node type:** LEAF
> - **Companion UVL:** `uvl/leaves/F-IAM-003-03.uvl`
> - **Companion AUI:** `contracts/aui/F-IAM-003-03.aui.yaml`
...
This feature lets a IAM_TENANT_ADMIN configure tenant-specific settings: feature flags, security policies, preferences.
...
### 1.1 The User Goal
Configure tenant-specific settings: feature flags, security policies, preferences.

### 1.2 User Scenarios
**Scenario 1: Enable MFA**
> Next login prompts MFA setup

**Scenario 2: Reduce session timeout**
> 30min for high-security
...
sequenceDiagram
    ...
    participant SVC as iam-tenant-svc
...
```
┌──────────────────────────────────────────────────┐
│  ← Back            Tenant Configuration     [Cancel]    │
├──────────────────────────────────────────────────┤
...
|---|---|---|:---:|---|
| Password Policy | `iam-tenant-svc` | Select |  | STANDARD/STRICT/CUSTOM |
| MFA Required | `iam-tenant-svc` | Toggle |  | Default false |
| Session Timeout | `iam-tenant-svc` | Number |  | 5-1440 min |
| Default Locale | `iam-tenant-svc` | Select |  | Locale catalog |
| Feature Flags | `iam-tenant-svc` | Toggle group |  | Per-feature |

### 3.2 Actions
| Action | Trigger | Precondition | Confirm | Role | Outcome |
|---|---|---|:---:|---|---|
| Submit | Button | Form valid | — | `IAM_TENANT_ADMIN` | Navigate + toast |
...
|---|---------|------|--------|:---:|---|
| 1 | iam-tenant-svc | T1 | GET ref data | N | Retry 3x |
| 2 | iam-tenant-svc | T1 | POST/PUT/PATCH | Y | Show error |
...
See companion file: `contracts/aui/F-IAM-003-03.aui.yaml`
...
| Submit | Always | Form valid | `IAM_TENANT_ADMIN` |

---

## 8. Acceptance Criteria
**AC-001:** Given role `IAM_TENANT_ADMIN`, when all required fields filled and submitted, then record created and toast shown.
