...
# F-IAM-001-03 — Create System Principal

> **Conceptual Stack Layer:** Platform-Feature
> **Space:** Platform
> **Owner:** Domain Engineering Team
> **Companion files:** `F-IAM-001-03.uvl`, `F-IAM-001-03.aui.yaml`
...
> - **Status:** DRAFT
> - **Feature ID:** `F-IAM-001-03`
> - **Suite:** `iam`
> - **Node type:** LEAF
> - **Companion UVL:** `uvl/leaves/F-IAM-001-03.uvl`
> - **Companion AUI:** `contracts/aui/F-IAM-001-03.aui.yaml`
...
This feature lets a IAM_SYSTEM_ADMIN register an external system integration that authenticates via mTLS or API key.
...
### 1.1 The User Goal
Register an external system integration that authenticates via mTLS or API key.

### 1.2 User Scenarios
**Scenario 1: Register ERP with API key**
> Create, generate key

**Scenario 2: Register partner with mTLS**
> Upload cert, store fingerprint
...
```
┌──────────────────────────────────────────────────┐
│  ← Back            Create System Principal     [Cancel]    │
├──────────────────────────────────────────────────┤
...
|---|---|---|:---:|---|
| System Name * | `iam-principal-svc` | Text | Y | 3-100, unique |
| Vendor * | `iam-principal-svc` | Text | Y | Max 200 |
| Description * | `iam-principal-svc` | Textarea | Y | Max 500 |
| Auth Method * | `iam-principal-svc` | Select | Y | API_KEY/MTLS/OAUTH2_CC |
| Tenant * | `iam-principal-svc` | Typeahead | Y | Active tenant |
| IP Whitelist | `iam-principal-svc` | Text |  | CIDRs |
...
See companion file: `contracts/aui/F-IAM-001-03.aui.yaml`
