...
# F-IAM-004-03 — Audit Export & Archival

> **Conceptual Stack Layer:** Platform-Feature
> **Space:** Platform
> **Owner:** Domain Engineering Team
> **Companion files:** `F-IAM-004-03.uvl`, `F-IAM-004-03.aui.yaml`
...
> - **Status:** DRAFT
> - **Feature ID:** `F-IAM-004-03`
> - **Suite:** `iam`
> - **Node type:** LEAF
> - **Companion UVL:** `uvl/leaves/F-IAM-004-03.uvl`
> - **Companion AUI:** `contracts/aui/F-IAM-004-03.aui.yaml`
...
This feature lets a IAM_AUDIT_ADMIN export audit events and configure automatic archival for retention compliance.
...
### 1.1 The User Goal
Export audit events and configure automatic archival for retention compliance.

### 1.2 User Scenarios
**Scenario 1: Export for external audit**
> 12mo CSV for auditor

**Scenario 2: Auto-archival config**
> Monthly >90d to cold storage
...
```
┌──────────────────────────────────────────────────┐
│  ← Back            Audit Export & Archival     [Cancel]    │
├──────────────────────────────────────────────────┤
...
|---|---|---|:---:|---|
| Date Range * | `iam-audit-svc` | Date range | Y | Export period |
| Format * | `iam-audit-svc` | Select | Y | CSV/JSON/PARQUET |
| Destination * | `iam-audit-svc` | Select | Y | DOWNLOAD/S3/AZURE_BLOB |
| Include PII | `iam-audit-svc` | Toggle |  | Default false |

### 3.2 Actions
| Action | Trigger | Precondition | Confirm | Role | Outcome |
|---|---|---|:---:|---|---|
| Submit | Button | Form valid | — | `IAM_AUDIT_ADMIN` | Navigate + toast |
...
See companion file: `contracts/aui/F-IAM-004-03.aui.yaml`
...
| Submit | Always | Form valid | `IAM_AUDIT_ADMIN` |

---

## 8. Acceptance Criteria
**AC-001:** Given role `IAM_AUDIT_ADMIN`, when all required fields filled and submitted, then record created and toast shown.
