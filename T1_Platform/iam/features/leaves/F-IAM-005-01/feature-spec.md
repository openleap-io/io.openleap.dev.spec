...
# F-IAM-005-01 — Data Export

> **Conceptual Stack Layer:** Platform-Feature
> **Space:** Platform
> **Owner:** Domain Engineering Team
> **Companion files:** `F-IAM-005-01.uvl`, `F-IAM-005-01.aui.yaml`
...
> - **Status:** DRAFT
> - **Feature ID:** `F-IAM-005-01`
> - **Suite:** `iam`
> - **Node type:** LEAF
> - **Companion UVL:** `uvl/leaves/F-IAM-005-01.uvl`
> - **Companion AUI:** `contracts/aui/F-IAM-005-01.aui.yaml`
...
This feature lets a IAM_PRINCIPAL_SELF export all personal data held about a principal (GDPR Art. 15 right of access).
...
### 1.1 The User Goal
Export all personal data held about a principal (GDPR Art. 15 right of access).

### 1.2 User Scenarios
**Scenario 1: Self-service export**
> Collect from all IAM svcs, encrypted download 48h

**Scenario 2: GDPR officer request**
> Formal DSAR, identity+profile+roles+memberships+audit
...
| Format * | `iam-principal-svc` | Select | Y | JSON/CSV |
| Include Audit | `iam-principal-svc` | Toggle |  | Default true |
| Encryption | `iam-principal-svc` | Toggle |  | Default true AES-256 |
...
See companion file: `contracts/aui/F-IAM-005-01.aui.yaml`
