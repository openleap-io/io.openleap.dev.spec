...
# F-IAM-004-04 — SIEM Integration

> **Conceptual Stack Layer:** Platform-Feature
> **Space:** Platform
> **Owner:** Domain Engineering Team
> **Companion files:** `F-IAM-004-04.uvl`, `F-IAM-004-04.aui.yaml`
...
> - **Status:** DRAFT
> - **Feature ID:** `F-IAM-004-04`
> - **Suite:** `iam`
> - **Node type:** LEAF
> - **Companion UVL:** `uvl/leaves/F-IAM-004-04.uvl`
> - **Companion AUI:** `contracts/aui/F-IAM-004-04.aui.yaml`
...
This feature lets a IAM_SYSTEM_ADMIN stream security events to external SIEM systems in real-time.
...
### 1.1 The User Goal
Stream security events to external SIEM systems in real-time.

### 1.2 User Scenarios
**Scenario 1: Connect to Splunk**
> Forward auth failures + denials in CEF

**Scenario 2: Test connection**
> Send test event, verify receipt
...
|---|---|---|:---:|---|
| SIEM Type * | `iam-audit-svc` | Select | Y | SPLUNK/ELK/AZURE_SENTINEL/SYSLOG |
| Endpoint URL * | `iam-audit-svc` | Text | Y | Ingestion endpoint |
| Auth | `iam-audit-svc` | Select |  | API_KEY/BASIC/OAUTH2/MTLS |
| Event Filter | `iam-audit-svc` | Multi-select |  | Event types |
| Format * | `iam-audit-svc` | Select | Y | CEF/LEEF/JSON/RFC5424 |
...
See companion file: `contracts/aui/F-IAM-004-04.aui.yaml`
