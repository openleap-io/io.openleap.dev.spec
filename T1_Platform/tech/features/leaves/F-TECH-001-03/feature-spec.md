# F-TECH-001-03 — Document Audit Trail
...
> - **Status:** DRAFT
> - **Feature ID:** `F-TECH-001-03`
> - **Suite:** `tech`
> - **Node type:** LEAF
> - **Parent:** `F-TECH-001` — Document Management
> - **Companion UVL:** `F-TECH-001-03.uvl`
> - **Companion AUI:** `F-TECH-001-03.aui.yaml`
...
This feature lets a **security auditor** view the access and modification history of any document so that compliance audits can trace who accessed or changed what.
### 0.2 Non-Goals
...
sequenceDiagram
    ...
    BFF->>SVC: GET /api/tech/dms/v1/documents/{id}/audit
    SVC-->>BFF: 200 OK
    BFF-->>Admin: Render
```
### 2.2 Screen Layout
See companion AUI contract `F-TECH-001-03.aui.yaml`.
...
|---|---------|----------|------|------------|-------------|
| 1 | tech-dms-svc | `GET /api/tech/dms/v1/documents/{id}/audit` | T1 | No | Error + retry |
