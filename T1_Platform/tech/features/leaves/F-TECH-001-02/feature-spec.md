# F-TECH-001-02 — Manage Retention Policies
...
> - **Status:** DRAFT
> - **Feature ID:** `F-TECH-001-02`
> - **Suite:** `tech`
> - **Node type:** LEAF
> - **Parent:** `F-TECH-001` — Document Management
> - **Companion UVL:** `F-TECH-001-02.uvl`
> - **Companion AUI:** `F-TECH-001-02.aui.yaml`
...
This feature lets a **compliance officer** create, view, and edit document retention policies so that regulatory requirements (GoBD, GDPR) are enforced automatically via S3 Object Lock.
### 0.2 Non-Goals
...
sequenceDiagram
    ...
    BFF->>SVC: GET/POST/PUT /api/tech/dms/v1/policies
    SVC-->>BFF: 200 OK
    BFF-->>Admin: Render
```
### 2.2 Screen Layout
See companion AUI contract `F-TECH-001-02.aui.yaml`.
...
|---|---------|----------|------|------------|-------------|
| 1 | tech-dms-svc | `GET/POST/PUT /api/tech/dms/v1/policies` | T1 | Yes | Error + retry |
