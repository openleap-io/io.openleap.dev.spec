# F-TECH-003-01 — Browse Jobs & Runners
...
> - **Status:** DRAFT
> - **Feature ID:** `F-TECH-003-01`
> - **Suite:** `tech`
> - **Node type:** LEAF
> - **Parent:** `F-TECH-003` — Job Control
> - **Companion UVL:** `F-TECH-003-01.uvl`
> - **Companion AUI:** `F-TECH-003-01.aui.yaml`
...
This feature lets a **platform operator** browse all registered runners and their health, plus all active/recent jobs with their lifecycle status, so that they can monitor the job processing pipeline.
### 0.2 Non-Goals
...
sequenceDiagram
    ...
    BFF->>SVC: GET /api/tech/jc/v1/runners + GET /api/tech/jc/v1/jobs
    SVC-->>BFF: 200 OK
    BFF-->>Admin: Render
```
### 2.2 Screen Layout
See companion AUI contract `F-TECH-003-01.aui.yaml`.
...
|---|---------|----------|------|------------|-------------|
| 1 | tech-jc-svc | `GET /api/tech/jc/v1/runners + GET /api/tech/jc/v1/jobs` | T1 | No | Error + retry |
