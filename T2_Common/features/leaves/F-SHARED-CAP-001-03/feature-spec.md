            # F-SHARED-CAP-001-03 — Holiday Management

            > **Conceptual Stack Layer:** Platform-Feature
            > **Space:** Platform
            > **Owner:** Domain Engineering Team
            > **Companion files:** `F-SHARED-CAP-001-03.uvl`, `F-SHARED-CAP-001-03.aui.yaml`
            ...
            > - **Status:** DRAFT
            > - **Feature ID:** `F-SHARED-CAP-001-03`
            > - **Suite:** `t2`
            > - **Node type:** LEAF
            > - **Parent:** `F-SHARED-CAP-001` — see `F-SHARED-CAP-001.md`
            > - **Companion UVL:** `F-SHARED-CAP-001-03.uvl`
            > - **Companion AUI:** `F-SHARED-CAP-001-03.aui.yaml`
...
├── F-SHARED-CAP-001-03  Holiday Management  [LEAF] <-- you are here
...
```
            ...
            | `F-SHARED-CAP-001-03.uvl` | Companion UVL — attribute schema, cross-suite requires |
            | `F-SHARED-CAP-001-03.aui.yaml` | Companion AUI — screen contract |
...
> They expect: A custom holiday is added and all plant calendars are affected.
            ...
            **Screen: Holiday Management — Default State**
            ...
            Fields are defined authoritatively in `domain-specs/shared_cap-spec.md` §3 (Domain Model) and §6 (REST API). This feature renders the fields relevant to holiday management.
            ...
            See companion file: `contracts/aui/F-SHARED-CAP-001-03.aui.yaml`
...
| CAP_ADMIN | Y | Y | Y | Y |
            ...
            **AC-2: Add Company Holiday**
            ...
            |---|---|---|
            | `F-SHARED-CAP-001-03` | T1 Reference Data | Validation of codes |
