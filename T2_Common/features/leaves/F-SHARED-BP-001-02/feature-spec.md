            # F-SHARED-BP-001-02 — Role Assignment

            > **Conceptual Stack Layer:** Platform-Feature
            > **Space:** Platform
            > **Owner:** Domain Engineering Team
            > **Companion files:** `F-SHARED-BP-001-02.uvl`, `F-SHARED-BP-001-02.aui.yaml`
            ...
            > - **Status:** DRAFT
            > - **Feature ID:** `F-SHARED-BP-001-02`
            > - **Suite:** `t2`
            > - **Node type:** LEAF
            > - **Parent:** `F-SHARED-BP-001` — see `F-SHARED-BP-001.md`
            > - **Companion UVL:** `F-SHARED-BP-001-02.uvl`
            > - **Companion AUI:** `F-SHARED-BP-001-02.aui.yaml`
...
├── F-SHARED-BP-001-02  Role Assignment  [LEAF] <-- you are here
...
```
            ...
            | `F-SHARED-BP-001-02.uvl` | Companion UVL — attribute schema, cross-suite requires |
            | `F-SHARED-BP-001-02.aui.yaml` | Companion AUI — screen contract |
...
> They expect: The role is deactivated and downstream domains archive their extensions.
            ...
            **Screen: Role Assignment — Default State**
            ...
            Fields are defined authoritatively in `domain-specs/shared_bp-spec.md` §3 (Domain Model) and §6 (REST API). This feature renders the fields relevant to role assignment.
            ...
            See companion file: `contracts/aui/F-SHARED-BP-001-02.aui.yaml`
...
| BP_ADMIN | Y | Y | Y | Y |
            ...
            **AC-2: Deactivate Supplier Role**
            ...
            |---|---|---|
            | `F-SHARED-BP-001-02` | T1 Reference Data | Validation of codes |
