            # F-SHARED-BP-001-05 — Party Relationships

            > **Conceptual Stack Layer:** Platform-Feature
            > **Space:** Platform
            > **Owner:** Domain Engineering Team
            > **Companion files:** `F-SHARED-BP-001-05.uvl`, `F-SHARED-BP-001-05.aui.yaml`
            ...
            > - **Status:** DRAFT
            > - **Feature ID:** `F-SHARED-BP-001-05`
            > - **Suite:** `t2`
            > - **Node type:** LEAF
            > - **Parent:** `F-SHARED-BP-001` — see `F-SHARED-BP-001.md`
            > - **Companion UVL:** `F-SHARED-BP-001-05.uvl`
            > - **Companion AUI:** `F-SHARED-BP-001-05.aui.yaml`
...
├── F-SHARED-BP-001-05  Party Relationships  [LEAF] <-- you are here
```
            ...
            | `F-SHARED-BP-001-05.uvl` | Companion UVL — attribute schema, cross-suite requires |
            | `F-SHARED-BP-001-05.aui.yaml` | Companion AUI — screen contract |
...
> They expect: An EMPLOYEE_OF relationship is created and HR domain reacts.
            ...
            **Screen: Party Relationships — Default State**
            ...
            Fields are defined authoritatively in `domain-specs/shared_bp-spec.md` §3 (Domain Model) and §6 (REST API). This feature renders the fields relevant to party relationships.
            ...
            See companion file: `contracts/aui/F-SHARED-BP-001-05.aui.yaml`
...
| BP_ADMIN | Y | Y | Y | Y |
            ...
            **AC-2: Create Employment**
            ...
            |---|---|---|
            | `F-SHARED-BP-001-05` | T1 Reference Data | Validation of codes |
