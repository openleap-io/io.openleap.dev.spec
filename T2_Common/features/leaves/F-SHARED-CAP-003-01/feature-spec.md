            # F-SHARED-CAP-003-01 — Period CRUD & Hierarchy

            > **Conceptual Stack Layer:** Platform-Feature
            > **Space:** Platform
            > **Owner:** Domain Engineering Team
            > **Companion files:** `F-SHARED-CAP-003-01.uvl`, `F-SHARED-CAP-003-01.aui.yaml`
            ...
            > - **Status:** DRAFT
            > - **Feature ID:** `F-SHARED-CAP-003-01`
            > - **Suite:** `t2`
            > - **Node type:** LEAF
            > - **Parent:** `F-SHARED-CAP-003` — see `F-SHARED-CAP-003.md`
            > - **Companion UVL:** `F-SHARED-CAP-003-01.uvl`
            > - **Companion AUI:** `F-SHARED-CAP-003-01.aui.yaml`
            ...
            This feature lets authorized users create, update, and organize periods (fiscal, operational, planning) in a hierarchy so that time-based reporting and planning boundaries are centrally defined .
            ...
            **Entry points:**
            - From the Period Management navigation menu
            ...
            **Exit points:**
            ...
            ```
            F-SHARED-CAP-003  Period Management  [COMPOSITION]
            ├── F-SHARED-CAP-003-01  Period CRUD & Hierarchy  [LEAF] <-- you are here
```
            ...
            |---|---|
            | `F-SHARED-CAP-003.md` | Parent composition — variability structure |
            | `F-SHARED-CAP-003-01.uvl` | Companion UVL — attribute schema, cross-suite requires |
            | `F-SHARED-CAP-003-01.aui.yaml` | Companion AUI — screen contract |
            ...
            Create, update, and organize periods (fiscal, operational, planning) in a hierarchy so that time-based reporting and planning boundaries are centrally defined.

            ### 1.2 User Scenarios


**Scenario 1: Create Fiscal Year**
> A Finance Controller wants to create fiscal year 2026 with quarterly sub-periods because financial reporting requires period boundaries.
> They navigate to the Period CRUD & Hierarchy screen, fill in the required data, and submit.
> They expect: The year period is created with 4 child quarter periods.


**Scenario 2: Close Period**
> A Finance Controller wants to close Q1 2026 for further postings because the quarter-end process is complete.
> They navigate to the Period CRUD & Hierarchy screen, fill in the required data, and submit.
> They expect: The period status changes to CLOSED and downstream domains are notified.
            ...
            sequenceDiagram
                ...
                participant UI as Period CRUD & Hierarchy UI
                participant BFF as BFF
                participant SVC as shared-cap-svc

                User->>UI: Navigate to Period CRUD & Hierarchy
            ...
            **Screen: Period CRUD & Hierarchy — Default State**

            ```
            ┌─────────────────────────────────────────────────┐
            │  [Period Management] > Period CRUD & Hierarchy              │  ← Breadcrumb
            ├─────────────────────────────────────────────────┤
            │  ┌─ Core Data ─────────────────────────────────┐│
            ...
            Fields are defined authoritatively in `domain-specs/shared_cap-spec.md` §3 (Domain Model) and §6 (REST API). This feature renders the fields relevant to period crud & hierarchy.
            ...
            See companion file: `contracts/aui/F-SHARED-CAP-003-01.aui.yaml`
...
| CAP_ADMIN | Y | Y | Y | Y |
            ...
            **AC-1: Create Fiscal Year**
            - **Given** a Finance Controller is on the Period CRUD & Hierarchy screen
            - **When** they create fiscal year 2026 with quarterly sub-periods
            - **Then** The year period is created with 4 child quarter periods.

            **AC-2: Close Period**
            - **Given** a Finance Controller is on the Period CRUD & Hierarchy screen
            - **When** they close Q1 2026 for further postings
            - **Then** The period status changes to CLOSED and downstream domains are notified.
            ...
            |---|---|---|
            | `F-SHARED-CAP-003-01` | T1 Reference Data | Validation of codes |
            ...
            |---|---|---|---|
            | `ext.f_t2_004_01.customFields` | zone | Additional fields from T3 domains | Zone hidden |
