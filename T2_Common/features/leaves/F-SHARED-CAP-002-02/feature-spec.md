            # F-SHARED-CAP-002-02 — Booking Templates

            > **Conceptual Stack Layer:** Platform-Feature
            > **Space:** Platform
            > **Owner:** Domain Engineering Team
            > **Companion files:** `F-SHARED-CAP-002-02.uvl`, `F-SHARED-CAP-002-02.aui.yaml`
            ...
            > - **Status:** DRAFT
            > - **Feature ID:** `F-SHARED-CAP-002-02`
            > - **Suite:** `t2`
            > - **Node type:** LEAF
            > - **Parent:** `F-SHARED-CAP-002` — see `F-SHARED-CAP-002.md`
            > - **Companion UVL:** `F-SHARED-CAP-002-02.uvl`
            > - **Companion AUI:** `F-SHARED-CAP-002-02.aui.yaml`
            ...
            **Exit points:**
            ...
            ├── F-SHARED-CAP-002-01  Slot & Booking  [LEAF]
├── F-SHARED-CAP-002-02  Booking Templates  [LEAF] <-- you are here
```
            ...
            | `F-SHARED-CAP-002-02.uvl` | Companion UVL — attribute schema, cross-suite requires |
            | `F-SHARED-CAP-002-02.aui.yaml` | Companion AUI — screen contract |
...
> They expect: The template is updated and new bookings inherit the new policy.
            ...
            **Screen: Booking Templates — Default State**
            ...
            Fields are defined authoritatively in `domain-specs/shared_cap-spec.md` §3 (Domain Model) and §6 (REST API). This feature renders the fields relevant to booking templates.
            ...
            See companion file: `contracts/aui/F-SHARED-CAP-002-02.aui.yaml`
            ...
            **AC-2: Update Cancellation Policy**
            ...
            |---|---|---|
            | `F-SHARED-CAP-002-02` | T1 Reference Data | Validation of codes |
