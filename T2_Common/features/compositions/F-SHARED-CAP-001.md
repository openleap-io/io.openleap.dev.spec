        # F-SHARED-CAP-001 --- Calendar Management

        > **Conceptual Stack Layer:** Platform-Feature (Composition Node)
        > **Space:** Platform
        > **Owner:** Domain Engineering Team
        > **Companion files:** F-SHARED-CAP-001.uvl
        ...
        > - **Status:** DRAFT
        > - **Feature ID:** `F-SHARED-CAP-001`
        > - **Suite:** `t2`
        > - **Node type:** COMPOSITION
        > - **Parent:** suite root (T2_UI)
        > - **Companion UVL:** `F-SHARED-CAP-001.uvl`
...
| `F-SHARED-CAP-001-04` | Availability Query | LEAF | mandatory |
        ...
        ```
        T2_UI  (suite root)
        +-- F-SHARED-CAP-001  Calendar Management  <-- you are here
            +-- F-SHARED-CAP-001-01  Resource Calendars  [LEAF] [mandatory]
    +-- F-SHARED-CAP-001-02  Working Patterns  [LEAF] [mandatory]
    +-- F-SHARED-CAP-001-03  Holiday Management  [LEAF] [mandatory]
    +-- F-SHARED-CAP-001-04  Availability Query  [LEAF] [mandatory]
