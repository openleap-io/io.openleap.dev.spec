        # F-SHARED-CAP-003 --- Period Management

        > **Conceptual Stack Layer:** Platform-Feature (Composition Node)
        > **Space:** Platform
        > **Owner:** Domain Engineering Team
        > **Companion files:** F-SHARED-CAP-003.uvl
        ...
        > - **Status:** DRAFT
        > - **Feature ID:** `F-SHARED-CAP-003`
        > - **Suite:** `t2`
        > - **Node type:** COMPOSITION
        > - **Parent:** suite root (T2_UI)
        > - **Companion UVL:** `F-SHARED-CAP-003.uvl`
        ...
        ```
        T2_UI  (suite root)
        +-- F-SHARED-CAP-003  Period Management  <-- you are here
            +-- F-SHARED-CAP-003-01  Period CRUD & Hierarchy  [LEAF] [mandatory]
```
        ...
        **Business rationale for this structure:**
        ...
        | This Node | Requires | Rationale |\n|---|---|---|\n| `F-SHARED-CAP-003` | `F-SHARED-CAP-001` | Periods are owned by calendars |
