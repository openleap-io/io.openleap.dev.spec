        # F-SHARED-BP-001 --- Party Management

        > **Conceptual Stack Layer:** Platform-Feature (Composition Node)
        > **Space:** Platform
        > **Owner:** Domain Engineering Team
        > **Companion files:** F-SHARED-BP-001.uvl
        ...
        > - **Status:** DRAFT
        > - **Feature ID:** `F-SHARED-BP-001`
        > - **Suite:** `t2`
        > - **Node type:** COMPOSITION
        > - **Parent:** suite root (T2_UI)
        > - **Companion UVL:** `F-SHARED-BP-001.uvl`
...
| `F-SHARED-BP-001-05` | Party Relationships | LEAF | optional |
        ...
        ```
        T2_UI  (suite root)
        +-- F-SHARED-BP-001  Party Management  <-- you are here
            +-- F-SHARED-BP-001-01  Create/Update Party  [LEAF] [mandatory]
    +-- F-SHARED-BP-001-02  Role Assignment  [LEAF] [mandatory]
    +-- F-SHARED-BP-001-03  Address Management  [LEAF] [mandatory]
    +-- F-SHARED-BP-001-04  Contact Management  [LEAF] [mandatory]
...
```
        ...
        **Business rationale for this structure:**
        ...
        - If the optional child `F-SHARED-BP-001-05` is excluded, related data entry fields are hidden in the mandatory children's screens.
