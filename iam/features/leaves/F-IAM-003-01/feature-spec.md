...
# F-IAM-003-01 — Tenant Lifecycle

> **Conceptual Stack Layer:** Platform-Feature
> **Space:** Platform
> **Owner:** Domain Engineering Team
> **Companion files:** `F-IAM-003-01.uvl`, `F-IAM-003-01.aui.yaml`
...
> - **Status:** DRAFT
> - **Feature ID:** `F-IAM-003-01`
> - **Suite:** `iam`
> - **Node type:** LEAF
> - **Companion UVL:** `uvl/leaves/F-IAM-003-01.uvl`
> - **Companion AUI:** `contracts/aui/F-IAM-003-01.aui.yaml`
...
This feature lets a IAM_SYSTEM_ADMIN create, activate, suspend, and delete tenants for the multi-tenant environment.
...
### 1.1 The User Goal
Create, activate, suspend, and delete tenants for the multi-tenant environment.

### 1.2 User Scenarios
**Scenario 1: Provision customer**
> Create tenant + KC Org + admin principal

**Scenario 2: Suspend delinquent**
> Block logins, preserve data

**Scenario 3: Delete test tenant**
> Purge all data
...
|---|---|---|:---:|---|
| Tenant Name * | `iam-tenant-svc` | Text | Y | 3-200, unique |
| Tenant Code * | `iam-tenant-svc` | Text | Y | UPPER_SNAKE_CASE |
| Description | `iam-tenant-svc` | Textarea |  | Max 500 |
| Tier * | `iam-tenant-svc` | Select | Y | FREE/STANDARD/PREMIUM/ENTERPRISE |
| Admin Email * | `iam-tenant-svc` | Email | Y | Initial admin |
| Data Residency | `iam-tenant-svc` | Select |  | EU/US/APAC |
...
See companion file: `contracts/aui/F-IAM-003-01.aui.yaml`
