...
# F-IAM-005-02 — Data Erasure

> **Conceptual Stack Layer:** Platform-Feature
> **Space:** Platform
> **Owner:** Domain Engineering Team
> **Companion files:** `F-IAM-005-02.uvl`, `F-IAM-005-02.aui.yaml`
...
> - **Status:** DRAFT
> - **Feature ID:** `F-IAM-005-02`
> - **Suite:** `iam`
> - **Node type:** LEAF
> - **Companion UVL:** `uvl/leaves/F-IAM-005-02.uvl`
> - **Companion AUI:** `contracts/aui/F-IAM-005-02.aui.yaml`
...
This feature lets a IAM_GDPR_OFFICER anonymize all personal data for a principal (GDPR Art. 17 right to erasure).
...
### 1.1 The User Goal
Anonymize all personal data for a principal (GDPR Art. 17 right to erasure).

### 1.2 User Scenarios
**Scenario 1: Process erasure**
> Anonymize, purge KC, redact audit, publish deleted event

**Scenario 2: Erasure with active sessions**
> Terminate sessions first, then anonymize
...
|---|---|---|:---:|---|
| Principal ID * | `iam-principal-svc` | Auto | Y | From path |
| Confirmation * | `iam-principal-svc` | Type-to-confirm | Y | Type username |
| Reason * | `iam-principal-svc` | Textarea | Y | Legal basis |
| Notify Domains | `iam-principal-svc` | Toggle |  | Default true |

### 3.2 Actions
| Action | Trigger | Precondition | Confirm | Role | Outcome |
|---|---|---|:---:|---|---|
| Submit | Button | Form valid | — | `IAM_GDPR_OFFICER` | Navigate + toast |
...
See companion file: `contracts/aui/F-IAM-005-02.aui.yaml`
...
| Submit | Always | Form valid | `IAM_GDPR_OFFICER` |

---

## 8. Acceptance Criteria
**AC-001:** Given role `IAM_GDPR_OFFICER`, when all required fields filled and submitted, then record created and toast shown.
