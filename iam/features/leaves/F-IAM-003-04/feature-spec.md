...
# F-IAM-003-04 — Tenant Quotas

> **Conceptual Stack Layer:** Platform-Feature
> **Space:** Platform
> **Owner:** Domain Engineering Team
> **Companion files:** `F-IAM-003-04.uvl`, `F-IAM-003-04.aui.yaml`
...
> - **Status:** DRAFT
> - **Feature ID:** `F-IAM-003-04`
> - **Suite:** `iam`
> - **Node type:** LEAF
> - **Companion UVL:** `uvl/leaves/F-IAM-003-04.uvl`
> - **Companion AUI:** `contracts/aui/F-IAM-003-04.aui.yaml`
...
This feature lets a IAM_SYSTEM_ADMIN define and monitor resource quotas per tenant for SaaS billing.
...
### 1.1 The User Goal
Define and monitor resource quotas per tenant for SaaS billing.

### 1.2 User Scenarios
**Scenario 1: Set free tier quota**
> 10 principals, 5 roles, 1GB

**Scenario 2: Monitor usage**
> Dashboard with 80%/95% alerts
...
|---|---|---|:---:|---|
| Max Principals | `iam-tenant-svc` | Number |  | Per tier |
| Max Roles | `iam-tenant-svc` | Number |  | Default 500 |
| Max Storage GB | `iam-tenant-svc` | Number |  | Per tier |
| API Rate Limit | `iam-tenant-svc` | Number |  | req/min per tier |
...
See companion file: `contracts/aui/F-IAM-003-04.aui.yaml`
