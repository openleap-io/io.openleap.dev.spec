...
# F-IAM-002-02 — Permission Check

> **Conceptual Stack Layer:** Platform-Feature
> **Space:** Platform
> **Owner:** Domain Engineering Team
> **Companion files:** `F-IAM-002-02.uvl`, `F-IAM-002-02.aui.yaml`
...
> - **Status:** DRAFT
> - **Feature ID:** `F-IAM-002-02`
> - **Suite:** `iam`
> - **Node type:** LEAF
> - **Companion UVL:** `uvl/leaves/F-IAM-002-02.uvl`
> - **Companion AUI:** `contracts/aui/F-IAM-002-02.aui.yaml`
...
This feature lets a Any authenticated service programmatic authorization check: can principal X do action Y on resource Z?
...
### 1.1 The User Goal
Programmatic authorization check: can principal X do action Y on resource Z?

### 1.2 User Scenarios
**Scenario 1: Cache hit — fast allow**
> <10ms ALLOW from Redis

**Scenario 2: Cache miss — DB eval**
> <50ms, result cached

**Scenario 3: Deny-by-default**
> DENY logged to audit
...
|---|---|---|:---:|---|
| Principal ID * | `iam-authz-svc` | UUID | Y | Valid principal |
| Permission * | `iam-authz-svc` | String | Y | Permission code |
| Resource ID | `iam-authz-svc` | String |  | Optional context |
| Tenant ID * | `iam-authz-svc` | UUID | Y | From JWT |

### 3.2 Actions
| Action | Trigger | Precondition | Confirm | Role | Outcome |
|---|---|---|:---:|---|---|
| Submit | Button | Form valid | — | `Any authenticated service` | Navigate + toast |
...
See companion file: `contracts/aui/F-IAM-002-02.aui.yaml`
...
| Submit | Always | Form valid | `Any authenticated service` |

---

## 8. Acceptance Criteria
**AC-001:** Given role `Any authenticated service`, when all required fields filled and submitted, then record created and toast shown.
