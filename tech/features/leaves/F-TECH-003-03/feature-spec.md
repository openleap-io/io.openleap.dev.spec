# F-TECH-003-03 — Job Execution History
...
> - **Status:** DRAFT
> - **Feature ID:** `F-TECH-003-03`
> - **Suite:** `tech`
> - **Node type:** LEAF
> - **Parent:** `F-TECH-003` — Job Control
> - **Companion UVL:** `F-TECH-003-03.uvl`
> - **Companion AUI:** `F-TECH-003-03.aui.yaml`
...
This feature lets a **platform operator** view the full execution history of a job including its restart chain, runner feedback, step progress, and error details so that failures can be diagnosed and jobs restarted.
### 0.2 Non-Goals
...
sequenceDiagram
    ...
    BFF->>SVC: GET /api/tech/jc/v1/jobs/{id}/runs
    SVC-->>BFF: 200 OK
    BFF-->>Admin: Render
```
### 2.2 Screen Layout
See companion AUI contract `F-TECH-003-03.aui.yaml`.
...
|---|---------|----------|------|------------|-------------|
| 1 | tech-jc-svc | `GET /api/tech/jc/v1/jobs/{id}/runs` | T1 | No | Error + retry |
