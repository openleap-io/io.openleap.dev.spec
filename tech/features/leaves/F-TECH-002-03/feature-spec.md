...
> - **Status:** DRAFT
> - **Feature ID:** `F-TECH-002-03`
> - **Suite:** `tech`
> - **Node type:** LEAF
> - **Parent:** `F-TECH-002` — Report Management
> - **Companion UVL:** `F-TECH-002-03.uvl`
> - **Companion AUI:** `F-TECH-002-03.aui.yaml`
...
This feature lets a **platform administrator** view the history of report render jobs with their status, output artifacts, and error details so that rendering issues can be diagnosed.
### 0.2 Non-Goals
...
sequenceDiagram
    ...
    BFF->>SVC: GET /api/tech/rpt/v1/renders
    SVC-->>BFF: 200 OK
    BFF-->>Admin: Render
```
### 2.2 Screen Layout
See companion AUI contract `F-TECH-002-03.aui.yaml`.
...
|---|---------|----------|------|------------|-------------|
| 1 | tech-rpt-svc | `GET /api/tech/rpt/v1/renders` | T1 | No | Error + retry |
