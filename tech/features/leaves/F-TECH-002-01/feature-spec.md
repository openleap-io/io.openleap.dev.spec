# F-TECH-002-01 — Browse Report Templates
...
> - **Status:** DRAFT
> - **Feature ID:** `F-TECH-002-01`
> - **Suite:** `tech`
> - **Node type:** LEAF
> - **Parent:** `F-TECH-002` — Report Management
> - **Companion UVL:** `F-TECH-002-01.uvl`
> - **Companion AUI:** `F-TECH-002-01.aui.yaml`
...
This feature lets a **platform administrator** browse all registered Jasper report templates with their versions and activation status so that they can manage the report catalog.
### 0.2 Non-Goals
...
sequenceDiagram
    ...
    BFF->>SVC: GET /api/tech/rpt/v1/templates
    SVC-->>BFF: 200 OK
    BFF-->>Admin: Render
```
### 2.2 Screen Layout
See companion AUI contract `F-TECH-002-01.aui.yaml`.
...
|---|---------|----------|------|------------|-------------|
| 1 | tech-rpt-svc | `GET /api/tech/rpt/v1/templates` | T1 | No | Error + retry |
